  ...
  foreach($_SESSION['cart'] as $product_id => $quantity) {
    ...
    if($result){
      ...
      if($obj = $result->fetch_object()) {
        ...
        $query = $mysqli->query("INSERT INTO orders (product_code, product_name, product_desc, price, units, total, email) VALUES('$obj->categories_id', '$obj->name', '$obj->description', $obj->price, $quantity, $cost, '$user')");
